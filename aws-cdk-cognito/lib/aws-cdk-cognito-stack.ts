...
export class AwsCdkCognitoStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: IAwsCognitoStackProps) {
    ...
    /* LAMBDA FUNCTIONS TRIGGERED WHEN USER LOGIN*/
    ...
    const userpoolClient = new cognito.UserPoolClient(this, 'yb-UserPoolClient', {
      userPool,
    ...
    const identityPool = new cognito.CfnIdentityPool(this, 'yb-IdentityPool', {
    ...
    const domain = userPool.addDomain('yb-CustomDomain', {
      customDomain: {
    ...
    NagSuppressions.addStackSuppressions(this, [
      ...
      },
      {
        ...
        appliesTo: [
          ...
          'Resource::arn:aws:s3:::yb-images-bucket/*',
          'Resource::arn:aws:s3:::yb-images-bucket/users/<cognito-identity.amazonaws.com:sub>/*',
          'Resource::*',
        ],
      },
